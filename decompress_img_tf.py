"""
This code read *.keras file and reproduce the image that stored there.
...
def restore_image_with_extension(
    model, original_height, original_width, target_height, target_width
):
...
def main(model_path, height, width, target_height=None, target_width=None):
    ...
    if target_height is None or target_width is None:
        restored_image = restore_image(model, height, width)
        output_path = f"{model_path}_restored.png"
    else:
        restored_image = restore_image_with_extension(
            model, height, width, target_height, target_width
        )
